...
{type:"info",id:"intro",title:"The Three Buckets",text:"Most people think they're stuck because they don't know what to do.\n\nThat's almost never the real reason.\n\nThere are exactly three buckets:\n\n• Don't Know How (10% of cases)\n• No Energy / Wrong Thing (30%)\n• Fear / Avoidance (60%)\n\nLet's find yours."},
...
{type:"info",id:"intro",title:"The Gap vs The Gain",text:"The Gap is measuring against an ideal you haven't reached. Always feels bad. The Gain is measuring backward from where you started. Always feels good. Most achievers live in the Gap. That's why they're miserable despite winning."},
...
{type:"info",id:"intro",title:"The 80/20 Rule",text:"20% of what you do produces 80% of your results. The other 80% is noise that feels productive. The fastest path isn't doing more -- it's doing less of the wrong things."},
...
{type:"info",id:"intro",title:"Root Cause Analysis",text:"Every problem you state is a symptom. 'I can't get clients' might really be 'I'm afraid of rejection.' We're going 5 levels deep."},
...
{type:"info",id:"intro",title:"The GROW Framework",text:"Four questions. Goal: what do you want? Reality: where are you now? Options: what could you do? Will: what WILL you do? Most people skip to options without clarity on goal or honesty about reality."},
...
{type:"info",id:"intro",title:"Weekly Reset",text:"Before you plan forward, look backward. Five fields. Five minutes. One focused week."},
...
{type:"info",id:"intro",title:"The Value Equation",text:"Value = (Dream Outcome x Perceived Likelihood) / (Time Delay x Effort). Most people only work on Dream Outcome. The denominators often matter more."},
...
{type:"info",id:"intro",title:"The Grand Slam Offer",text:"Six components: dream outcome, high likelihood, fast value, low effort, killer bonuses, risk-removing guarantee. Most offers nail one or two. We're nailing all six."},
...
{type:"info",id:"intro",title:"The Fast Cash System",text:"When revenue is urgent, don't build new things. Four places money hides: past customers, unconverted leads, underpriced offers, and unfulfilled promises."},
...
{type:"info",id:"intro",title:"Theory of Constraints",text:"Your business is a chain. Weakest link determines everything. Identify the constraint. Exploit it. Subordinate everything to it. Elevate it. Repeat."},
...
{type:"info",id:"intro",title:"USP Formula",text:"'Why should I buy from you instead of anyone else?' If your answer is 'great quality and service,' you don't have a USP."},
...
{type:"info",id:"intro",title:"The Value Ladder",text:"One product is a business. A value ladder is an empire. Free → Low → Mid → High → Premium. Each rung solves a bigger problem."},
...
{type:"info",id:"intro",title:"The CLOSER Framework",text:"C=Clarify why they're here. L=Label the problem. O=Overview past. S=Sell the vacation (outcome). E=Explain concerns. R=Reinforce."},
...
{type:"info",id:"intro",title:"Direction Deficit",text:"Performance = Capacity x Regulation x Direction / Load. Imagine a steel wall. Most people try 5 walls and break none."},
...
{type:"info",id:"intro",title:"The 7 Forces",text:"Like a wheel with 7 spokes. One weak spoke and the whole wheel wobbles."},
...
{type:"info",id:"intro",title:"The Core Four",text:"Four ways: (1) Warm Outreach (2) Cold Outreach (3) Content (4) Paid Ads. Everything else is a flavor of these."},
...
{type:"info",id:"intro",title:"The 9 Stages",text:"Every business passes through stages. Each has a different bottleneck. Let's find yours."},
...
{type:"info",id:"intro",title:"MAGIC Naming",text:"Your offer name does 80% of the selling. MAGIC = Magnetic, Alluring, Goal-focused, Irresistible, Claim. Let's build yours."},
...
{type:"info",id:"intro",title:"Risk Reversal",text:"Every transaction has risk. Who holds it? The more risk you absorb, the easier the sale."},
...
{type:"info",id:"intro",title:"The Bonus Stack",text:"Great bonuses solve specific problems BEFORE, DURING, or AFTER your core offer."},
...
{type:"info",id:"intro",title:"The Rule of 100",text:"Every day: 100 outreach OR $100 on ads. Not 10. Not 30. 100. Volume solves most lead gen problems."},
...
{type:"info",id:"intro",title:"Market Intelligence",text:"Most businesses guess. Kennedy's questions eliminate guessing. Answer these and you'll know your customer better than their spouse does."},
...
{type:"info",id:"intro",title:"The Ascension Ladder",text:"Frontend gets them in. Backend gets you rich. Most businesses have a frontend and... nothing."},
...
{type:"info",id:"intro",title:"Authority Building",text:"Nobody buys from nobodies. Authority isn't earned over decades -- it's built strategically."},
...
{type:"info",id:"intro",title:"The Expert Path",text:"Five stages. Most try to sell at stage 2. The money is at stage 4+."},
...
{type:"info",id:"intro",title:"New Opportunity",text:"'Improvement' competes on price. 'New opportunity' creates its own category."},
...
{type:"info",id:"intro",title:"Building a Movement",text:"Customers buy once. Movements buy forever. Three things: a leader with a cause, a Big Domino belief, and an identity shift."},
...
{type:"info",id:"intro",title:"Model of Reality",text:"They say no because their mental model doesn't include your solution working. Change the model, change the sale."},
...
{type:"info",id:"intro",title:"Persuasional Relativity",text:"Nothing is expensive in isolation. Everything is relative. '$1,000 course' vs '$50K in lost revenue.' The frame determines the conclusion."},
...
{type:"info",id:"intro",title:"The 10-80-10 Split",text:"10% buy anything. 10% never buy. 80% are persuadable by BELIEFS, not discounts. If you're discounting, you're talking to the wrong segment."},
...
{type:"info",id:"intro",title:"Objection Tiers",text:"Tier 1: Price. Tier 2: Time. Tier 3: Belief. 80% of 'too expensive' is really 'I don't believe it'll work for ME.'"},
...
{type:"info",id:"intro",title:"14-Step Webinar",text:"Content IS the pitch. Every section reframes beliefs toward the sale."},
...
{type:"info",id:"intro",title:"Fear of Success",text:"Some want the result but sabotage unconsciously. Success changes who they are. Identity change is terrifying."},
...
{type:"info",id:"intro",title:"Be Your Future Self Now",text:"Your future self is the most important person in your life. If you can't picture them, you can't become them."},
...
{type:"info",id:"intro",title:"The Triad",text:"State runs on: physiology, focus, language. Change any one. Fastest? Body."},
...
{type:"info",id:"intro",title:"The 6 Needs",text:"Certainty, Variety, Significance, Connection, Growth, Contribution. Any behavior meeting 3+ becomes addictive."},
...
{type:"info",id:"intro",title:"The Dickens Process",text:"You know a belief is wrong. But you keep acting on it. We'll make the cost so painful that letting go is easier."},
...
{type:"info",id:"intro",title:"The 10x Paradox",text:"2x: do more. 10x: what would I STOP? Elimination is where gains hide."},
...
{type:"info",id:"intro",title:"Who Not How",text:"'How do I do this?' is a trap. Better: 'Who already knows?'"},
...
{type:"info",id:"intro",title:"Belief-Action Flywheel",text:"Belief → Action → Evidence → Stronger Belief → Bolder Action. Breaks: evidence too slow, or doubt kills belief."},
...
{type:"info",id:"intro",title:"The Wheel of Life",text:"You feel 'off' but can't explain why. The Wheel shows the flat tire."},
...
{type:"info",id:"intro",title:"Commitment Deficit",text:"Starting feels like progress. Every restart resets compound interest to zero."},
...
{type:"info",id:"intro",title:"Priming",text:"Most let the day happen. Priming: manufacture state before the world touches you."},
...
{type:"info",id:"intro",title:"7 Threats",text:"Your future self has seven enemies working right now. Most people only fight one."},
...
{type:"info",id:"intro",title:"Frame / Floor / Focus",text:"FRAME: impossibly big destination. FLOOR: raise your minimum. FOCUS: fewer paths."},
...
{type:"info",id:"intro",title:"RPM",text:"Most plan by listing tasks. Backward. Start with RESULT, connect to PURPOSE, THEN action. Purpose fuels follow-through."},
...
{type:"info",id:"intro",title:"NAC",text:"Six steps: Decide. Leverage (make pain of staying > pain of changing). Interrupt. Create alternative. Condition. Test."},
...
{type:"info",id:"intro",title:"Identity Armor",text:"You're not lazy. You're procrastinating because trying and failing threatens your identity. If you never launch, you never fail."},
...
{type:"info",id:"intro",title:"Calibration",text:"Most goals are boringly realistic AND next steps are overwhelmingly big. Flip both."},
  ...
  const renderStore=()=>(
    <div style={{padding:desk?24:16,maxWidth:wide?900:640,margin:"0 auto"}}>
      ...
      {BUNDLES.filter(b=>b.highlight).map(b=><div key={b.id} style={{background:"#1e293b",borderRadius:12,padding:desk?20:16,marginBottom:16,border:"2px solid #f59e0b"}}>
        ...
        <a href={b.url} target="_blank" rel="noopener noreferrer" style={{display:"inline-block",padding:"12px 32px",borderRadius:8,border:"none",background:"#f59e0b",color:"#0f172a",fontWeight:700,fontSize:20,cursor:"pointer",textDecoration:"none"}} onClick={()=>track("buy_link_clicked",{bundle_id:b.id,bundle_name:b.name,price:b.price})}>Buy Now →</a>
      </div>)}
      ...
      <div style={{display:"grid",gridTemplateColumns:desk?"1fr 1fr":"1fr",gap:10,marginBottom:20}}>
        {BUNDLES.filter(b=>["business-domain","personal-domain"].includes(b.id)).map(b=>{const owned=state.unlockedBundles.includes(b.id);return(
          <div key={b.id} style={{background:"#1e293b",borderRadius:12,padding:14,border:`1px solid ${b.color}44`}}>
            ...
            {!owned&&<a href={b.url} target="_blank" rel="noopener noreferrer" onClick={()=>track("buy_link_clicked",{bundle_id:b.id,bundle_name:b.name,price:b.price})} style={{color:b.color,fontSize:17,fontWeight:600,textDecoration:"none"}}>Buy Now →</a>}
          </div>)})}
      </div>
      ...
      <div style={{display:"grid",gridTemplateColumns:wide?"1fr 1fr 1fr":desk?"1fr 1fr":"1fr",gap:8}}>
        {BUNDLES.filter(b=>!["business-domain","personal-domain","all-access"].includes(b.id)).map(b=>{const owned=state.unlockedBundles.includes(b.id);return(
          <div key={b.id} style={{background:"#1e293b",borderRadius:10,padding:14,border:"1px solid #334155"}}>
            ...
            {!owned&&<a href={b.url} target="_blank" rel="noopener noreferrer" onClick={()=>track("buy_link_clicked",{bundle_id:b.id,bundle_name:b.name,price:b.price})} style={{color:"#f59e0b",fontSize:20,fontWeight:600,textDecoration:"none"}}>Buy Now →</a>}
          </div>)})}
      </div>
    </div>
  );
